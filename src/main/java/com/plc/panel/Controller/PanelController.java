...
//        String sql2 = "SELECT machine_id FROM public.tblmachine_details ORDER BY machine_id DESC limit 1";
//        PreparedStatement pstn2 = con.prepareStatement(sql2);
//        ResultSet rs2 = pstn2.executeQuery();
//        while (rs2.next()) {
////            int k = rs2.getInt("machine_id");
//            int k=1;
